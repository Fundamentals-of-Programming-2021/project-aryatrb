...
void load_everything()
{
    ...
    size_of_each_cell_x=162*(double)window_width/1920,size_of_each_cell_y=140*(double)window_width/1920;
    size_new_game_x = 327*(double)window_width/1335,size_new_game_y=37*(double)window_width/1335;
    size_load_game_x = 327*(double)window_width/1335,size_load_game_y=37*(double)window_width/1335;
    leaderboard_game_x = 327*(double)window_width/1335,leaderboard_game_y=37*(double)window_width/1335;
    size_credits_x = 163*(double)window_width/1335,size_credits_y=37*(double)window_width/1335;
    backbutton_x_y=50*((double)window_width/1920);
    start_game_x = 327*(double)window_width/1335 , start_game_y =37*(double)window_width/1335;
    size_of_leaders_x_y=45*((float)size_of_each_cell_x/81);
    size_of_troopers_x_y=20*((float)size_of_each_cell_x/81);
    size_of_kyber_photo_x = 40*((float)size_of_each_cell_x/162), size_of_kyber_photo_y=72*((float)size_of_each_cell_x/162);
    credits_text_x=1100*(double)window_width/1352,credits_text_y=1307*(double)window_width/1335;
    doordonot_x = 726*(double)window_width/1335, doordonot_y = 37*(double)window_width/1335;
    ifyoudefine_x = 801*(double)window_width/1335, ifyoudefine_y = 115*(double)window_width/1335;
    credits_text_loc_y=10*((double)window_height/1080);
    size_of_closebutton_x_y = 20*((double)window_width/1920);
    loc_number_of_enemies_x = (int)((double)window_width*0.1), loc_number_of_enemies_y = (int)((double)window_height*0.1);
    size_of_wall_y=(int)(60*((double)window_height/(double)1080));


    number_of_soldiers = TTF_OpenFont("assets/EPISODE1.TTF",18*(double)window_width/1920);
    number_of_soldiers_outline = TTF_OpenFont("assets/EPISODE1.TTF",18*(double)window_width/1920);
    details_page = TTF_OpenFont("assets/Starjedi.ttf",40*(double)window_width/1920);
    details_page_outline = TTF_OpenFont("assets/Starjedi.ttf",40*(double)window_width/1920);
    ...
    savebutton_target.x = window_width - (int)(60*(double)window_width/1920) - savebutton_target.w;
    ...
    new_game_target.y= window_height/2 + (double)window_height/2*160/300 - size_new_game_y/2;
    new_game_target.w= size_new_game_x;
    new_game_target.h= size_new_game_y;
    load_game_target.x = window_width/2 - size_load_game_x/2;
    load_game_target.y = window_height/2 + (double)window_height/2*205/300 - size_load_game_y/2;
    ...
    leaderboard_target.y = window_height/2 + (double)window_height/2*250/300 - leaderboard_game_y/2;
    leaderboard_target.w = leaderboard_game_x;
    leaderboard_target.h = leaderboard_game_y;
    credits_target.x = 180*(double)window_width/1335- size_credits_x/2;
    credits_target.y = window_height -50*(double)window_width/1335 - size_credits_y/2;
    credits_target.w = size_credits_x;
    credits_target.h = size_credits_y;
    start_game_target.x = window_width - 150*(double)window_width/1335 -start_game_x/2;
    start_game_target.y = window_height - 50*(double)window_width/1335 - start_game_y/2;
    ...
    updownbutton_target.x = loc_number_of_enemies_x + number_of_enemies_w + 50*(double)window_width/1920;
    updownbutton_target.y = enemies_target.y + (int)(enemies_target.h*0.1);
    updownbutton_target.w = 40*(double)window_width/1920;
    updownbutton_target.h = 60*(double)window_width/1920;
    updownbutton_sec_target.x = loc_number_of_enemies_x + per_user_w + 50*(double)window_width/1920;
    updownbutton_sec_target.y = per_user_target.y + (int)(per_user_target.h*0.1);
    updownbutton_sec_target.w = 40*(double)window_width/1920;
    updownbutton_sec_target.h = 60*(double)window_width/1920;
    updownbutton_thi_target.x = loc_number_of_enemies_x + number_of_nomansland_target.w + 50*(double)window_width/1920;
    updownbutton_thi_target.y = number_of_nomansland_target.y + (int)(number_of_nomansland_target.h*0.1);
    updownbutton_thi_target.w = 40*(double)window_width/1920;
    updownbutton_thi_target.h = 60*(double)window_width/1920;
    updownbutton_fou_target.x = loc_number_of_enemies_x + maxtrooperinplayers_house.w + 50*(double)window_width/1920;
    updownbutton_fou_target.y = maxtrooperinplayers_house.y + (int)(maxtrooperinplayers_house.h*0.1);
    updownbutton_fou_target.w = 40*(double)window_width/1920;
    updownbutton_fou_target.h = 60*(double)window_width/1920;
    updownbutton_fiv_target.x = maxtrooperinnomansland_target.x + maxtrooperinnomansland_target.w + 50*(double)window_width/1920;
    updownbutton_fiv_target.y = maxtrooperinnomansland_target.y + (int)(maxtrooperinnomansland_target.h*0.1);
    updownbutton_fiv_target.w = 40*(double)window_width/1920;
    updownbutton_fiv_target.h = 60*(double)window_width/1920;
    updownbutton_six_target.x = start_troop_insomo_la_target.x + start_troop_insomo_la_target.w + 50*(double)window_width/1920;
    updownbutton_six_target.y = start_troop_insomo_la_target.y + (int)(start_troop_insomo_la_target.h*0.1);
    updownbutton_six_target.w = 40*(double)window_width/1920;
    updownbutton_six_target.h = 60*(double)window_width/1920;
    updownbutton_sev_target.x = number_of_systems_of_user_target.x + number_of_systems_of_user_target.w + 50*(double)window_width/1920;
    updownbutton_sev_target.y = number_of_systems_of_user_target.y + (int)(number_of_systems_of_user_target.h*0.1);
    updownbutton_sev_target.w = 40*(double)window_width/1920;
    updownbutton_sev_target.h = 60*(double)window_width/1920;
    updownbutton_eig_target.x = select_character_target.x + select_character_target.w + 50*(double)window_width/1920;
    updownbutton_eig_target.y = select_character_target.y + (int)(select_character_target.h*0.1);
    updownbutton_eig_target.w = 40*(double)window_width/1920;
    updownbutton_eig_target.h = 60*(double)window_width/1920;
